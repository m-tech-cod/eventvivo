...
// La page "Premium" fait passer un événement existant au plan Prestige
// (QR Code, PDF HD, Export Excel, 50 styles — cf. PricingSection.tsx)
const UPGRADE_PLAN = 'prestige'
...
export default function PremiumPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const basePrice = getPriceForCurrency(detectedCurrency, UPGRADE_PLAN)
        setOriginalPrice(basePrice)
        setPrice(basePrice)
        setSymbol(getCurrencySymbol(detectedCurrency))
      } catch {
        setCurrency('USD')
        const basePrice = getPriceForCurrency('USD', UPGRADE_PLAN)
        setOriginalPrice(basePrice)
        setPrice(basePrice)
        setSymbol('$')
      }
  ...
  // ✅ Un seul clic sur un moyen de paiement suffit à lancer la redirection FedaPay
  ...
  return (
    <BackgroundImage src={event.cover_image || '/images/foule.webp'} overlayOpacity={0.35} animate="zoom">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <ul className="space-y-1.5 text-gray-600">
                    <li className="flex items-center gap-2">✅ Jusqu'à 500 invités</li>
                    <li className="flex items-center gap-2">✅ QR Codes sécurisés</li>
                    <li className="flex items-center gap-2">✅ Export Excel + PDF HD</li>
                    <li className="flex items-center gap-2">✅ 50 styles premium</li>
                    <li className="flex items-center gap-2">✅ Contrôle d'accès</li>
                  </ul>
                </div>
                ...
                {/* Méthode de paiement — clic direct = redirection FedaPay immédiate */}
