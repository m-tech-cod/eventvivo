        ...
        >
          <Card className="w-full shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-[#1E3A8A]">Connexion</CardTitle>
              <CardDescription>
                Connectez-vous à votre compte Eventvivo
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex flex-col gap-4 border-t pt-6">
              <div className="text-sm text-gray-600">
                <Link href="/fr/auth/reset-password" className="text-[#1E3A8A] hover:underline">
                  Mot de passe oublié ?
                </Link>
              </div>
              <div className="text-sm text-gray-600">
                Pas encore de compte ?{' '}
                <Link href="/fr/auth/register" className="text-[#F59E0B] hover:underline font-medium">
                  Créer un compte
                </Link>
              </div>
            </CardFooter>
